...
class LooselyCoupledKF : public Node
{
  ...
  private:
    ...
    /// @brief Vector with only Baro keys for n-system
    ...
    [[nodiscard]] static KeyedMatrix<double, KFMeas, KFMeas, 1, 1> baroMeasurementNoiseCovariance_R(const double BaroVarianceAltitude);
